...
set output 'bwheatmap.png'

set palette color positive
set samples 50; set isosamples 50
set tics norotate nooffset

#set title "Heat Map for intra-cloud bandwidths in MB/sec"
set tic scale 0
...
set cbrange [0:40]
set cblabel "Bandwidth in MB/sec"
...
#set xlabel "Virginia   California   Oregon   Ireland   Sao-Paulo   Sydney   Singapore   Tokyo"
#set ylabel "Virginia California Oregon Ireland Sao-Paulo Sydney Singapore Tokyo"
set view map
splot 'the_bwmatrix.txt' matrix with image
